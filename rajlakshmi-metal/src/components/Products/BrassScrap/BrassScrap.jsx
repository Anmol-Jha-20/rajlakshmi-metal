...
const BrassScrapCategoryPage = () => {
  ...
  const products = [
    ...
    {
      id: 2,
      name: "Brass Turning Boring Scrap",
      price: 430,
      unit: "Kg",
      images: [
      ...
      <div className="bg-white py-4 border-b">
        <div className="container mx-auto px-4">
          <nav className="text-sm">
            ...
            <span className="mx-2 text-gray-400">/</span>
            <span className="text-gray-800 font-medium">Brass Scrap</span>
          </nav>
        </div>
      </div>
...
export default BrassScrapCategoryPage;
